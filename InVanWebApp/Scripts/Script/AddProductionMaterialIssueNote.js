...
function SelectedIndexChangedPI(id) {
    ...
    if (Location_ID == null || Location_ID == '') {
        ...
        $("#LocationIdErr").text("Select Location!");
    ...
    var selectedOptionPI, PINo;
    selectedOptionPI = document.getElementById("ProductionIndentId").selectedIndex;
    PINo = document.getElementById("ProductionIndentId").options[selectedOptionPI].innerText;
    document.getElementById("ProductionIndentNo").value = PINo;
    ...
    var ProductionIndent_Id = $("#ProductionIndentId").val();
    var Location_ID = $("#LocationId").val();

    ///This call is for binding the item list on that Production Indent.

    $.ajax({
        url: '/ProductionMaterialIssueNote/GetProductionIndentItemList',
        type: "POST",
        data: { id: ProductionIndent_Id },
        ...
        error: function (err) {
            alert('Not able to fetch item list of that Production Indent!');
    ...
    $.ajax({
        url: '/ProductionMaterialIssueNote/GetLocationStocksDetails',
        type: "POST",
        data: { id: ProductionIndent_Id, locationId: Location_ID },
        success: function (result) {
...
function SelectedIndexChangedWO(id) {    
    ...
    selectedOptionWO = document.getElementById("SalesOrderId").selectedIndex;
    WONo = document.getElementById("SalesOrderId").options[selectedOptionWO].innerText;
    document.getElementById("WorkOrderNumber").value = WONo;
}
//WO Number end 
...
function SelectedIndexChangedLocation(id) {
    $("#LocationIdErr").hide();
    var selectedOptionLocationId, locationName;
    selectedOptionLocationId = document.getElementById("LocationId").selectedIndex;
...
function OnChangeQty(value, id) {
    ...
    var rowNo = id.split('_')[1];
    var RequestedQty = document.getElementById("txtRequestedQty_" + rowNo).innerHTML;
...
function createJson() {
    ...
    while (i < rowCount - 1) {
        ...
        var ReqQty = (document.getElementById("txtRequestedQty_" + i)).innerHTML;
        var IssueQty = (document.getElementById("txtIssuedQty_" + i)).value;
