    ...
    function createCustomDropdown_SO_Id() {
        $('select#SO_Id').each(function (i, select) {
            ...
            if (!$(this).next().hasClass('dropdown-select')) {
                ...
                $(this).after('<div id="divSO_Id" class="dropdown-select wide d-flex align-items-center' + ($(this).attr('class') || '') + '" tabindex="0"><span class="current"></span><div class="list"><ul></ul></div></div>');
